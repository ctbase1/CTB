  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto max-w-3xl px-6 py-16">
        <h1 className="mb-2 text-3xl font-bold text-violet-400">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-sm leading-relaxed text-slate-300">
          ...
          <section>
            <h2 className="mb-3 text-base font-semibold text-white">3. Data Processors</h2>
          ...
          <section>
            <h2 className="mb-3 text-base font-semibold text-white">5. Cookies</h2>
          ...
          <section>
            <h2 className="mb-3 text-base font-semibold text-white">7. Your Rights (GDPR / CCPA)</h2>
