  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto max-w-3xl px-6 py-16">
        <h1 className="mb-2 text-3xl font-bold text-violet-400">Terms & Conditions</h1>
        <p className="mb-10 text-sm text-slate-500">Last updated: April 13, 2026</p>
        ...
        <div className="space-y-8 text-sm leading-relaxed text-slate-300">
          ...
          <section>
            <h2 className="mb-3 text-base font-semibold text-white">3. User-Generated Content</h2>
          ...
          <section>
            <h2 className="mb-3 text-base font-semibold text-white">4. No Financial Advice</h2>
          ...
          <section>
            <h2 className="mb-3 text-base font-semibold text-white">5. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="mb-3 text-base font-semibold text-white">7. Account Suspension and Termination</h2>
          ...
          <section>
            <h2 className="mb-3 text-base font-semibold text-white">8. DMCA / Copyright</h2>
          ...
          <section>
            <h2 className="mb-3 text-base font-semibold text-white">9. Dispute Resolution</h2>
        ...
        <div className="mt-12 flex gap-4 text-xs text-slate-600">
          ...
          <a href="/guidelines" className="hover:text-slate-400 transition-colors">Community Guidelines</a>
